...
export default function Dashboard (){
                ...
                <div style={{display: "flex", alignItems: "center", justifyContent: 'center', padding: 20}}>
                    ...
                    <Button rightSection={<IconEdit size={20}  />} onClick={() =>
                        modals.open({
                            ...
                            children: <UpdatePixel pixelSelected={row} onCancel={() => modals.closeAll()} refreshPixels={refreshPixel}/>,
    ...
    return<div style={{display: 'flex', flexDirection: 'column', padding: 80, marginRight: 40, marginLeft: 80}}>
        <h2>Dashboard</h2>
        <div style={{display: 'flex', justifyContent: 'space-around', alignItems: 'center'}}>
            ...
            <Button rightSection={<IconPlus size={20} />} onClick={() => modals.open({
                ...
                labels: { confirm: "Save", cancel: "Cancel" },
                children: <AddPixel onCancel={() => modals.closeAll()} refreshPixels={refreshPixel}/>,
                withCloseButton: false,
            })
